...
<form method="POST" action="" id="qnz">
<div id='TextBoxesGroup'>

<input type="hidden" name="coun" id="coun">
<input type="hidden" name="test" id="test">
	<div id="TextBoxDiv1" class="form-group col-md-4">
		<label>Full name </label><input type='textbox' id='fname' name="fname" class="form-control">
	</div>
	<div id="TextBoxDiv1" class="form-group col-md-4">
		<label>Username</label><input type='textbox' id='username' name="username" class="form-control">
	</div>
	<div id="TextBoxDiv1" class="form-group col-md-4">
...
<div id="TextBoxDiv1" class="form-group col-md-4">
	...
	<div id="TextBoxDiv1" class="form-group col-md-4" style="text-align: center;">
		<input type='submit' value='Add Admin' id='addButton' name="add_admin" class="btn btn-info">
	</div>
	<div id="TextBoxDiv1" class="form-group col-md-4">
...
if (isset($_POST['add_admin'])) {
	...
	$add="INSERT INTO admin (full_name,username,password) VALUES('$fullname','$username','$password')";
	$mysql=mysqli_query($con,$add);
	if ($mysql) {
		echo "<script>
toastr.success('Success!', 'Admin Added', {
	...
	echo "<script>
toastr.error('Error!', 'Admin Not Added ".mysqli_error('$con')." ' , {
        closeButton: true,
        progressBar: true,
    });
